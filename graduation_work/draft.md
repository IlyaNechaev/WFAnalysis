...
Также надо дать вводные перед тестированием: какие будут тестовые данные, что будет пониматься под токенизацией и т.д.
`draft_end`
...
* В.И. Ляшевская, О.Ю. Степанова, Морфологический анализ текста: теория и алгоритмы. Москва, 2007.
* J. Nivre, M. de Marneffe, F. Ginter, Y. Goldberg, J. Hajič, C. D. Manning, R. McDonald, S. Petrov, S. Pyysalo, N. Silveira, R. Tsarfaty, D. Zeman, Universal Dependencies v2: An Evergrowing Multilingual Treebank Collection, LREC 2018.
* P. Ljubešić, T. Erjavec, and A. Lavrač. 2012. Comparing different approaches to unsupervised morpheme segmentation. Computational Linguistics 38(2): 365–393.
