...
![Схема тестирования морфологических анализаторов.](./sources/images/architecture.png){#fig:architecture}
...
Основываясь на описании этих классов, перечислим этапы работы программы:
